 ...
 * @author NITRO
 */
public class JFrameDataSupplier extends javax.swing.JFrame {

    /**
     * Creates new form JFrameDataSupplier
     */
    public JFrameDataSupplier() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Tanggal Masuk", "Kode Supplier", "Nama Supplier", "Alamat", "No. Telp", "Keterangan"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameDataSupplier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameDataSupplier().setVisible(true);
            }
        });
    }
